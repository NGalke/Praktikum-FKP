...
Angewandt auf die Elektronen im Festkörper bedeutet das also, dass neben den Wechselwirkungen der Elektronen miteinander auch das periodische Kristallpotential nicht wirklich berücksichtigt wird. Dies kann aber zumindest teilweise durch das Bloch-Theorem gerechtfertigt werden, aus welchem sich ableiten lässt, dass die Dispersionsrelation der Elektronen im Kristall (unter den richtigen Umständen) die eines freien Teilchens mit
einer passenden \emph{effektiven Masse} ist (\cite{czy15}).
